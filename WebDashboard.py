...
original_data = pd.read_csv("/app/NotebookAndModel/DATA/marketing_campaign.csv", sep="\t")
no_clusters_PCA = pd.read_csv("/app/NotebookAndModel/DATA/no_clusters_pca.csv")
clustered_PCA = pd.read_csv("/app/NotebookAndModel/DATA/clustered_pca.csv")
clustered_data = pd.read_csv("/app/NotebookAndModel/DATA/clustered_data.csv")
